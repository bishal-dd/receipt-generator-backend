...
func (r *ReceiptPDFGeneratorResolver) LoadServiceFromEncryptedReceipt(ctx context.Context, receipt *model.EncryptedReceipt) (*model.EncryptedReceipt, error) {
	loaders := loaders.For(ctx)
...
func (r *ReceiptPDFGeneratorResolver) decryptService(service *model.EncryptedService) error {
